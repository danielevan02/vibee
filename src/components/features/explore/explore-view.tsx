...
/**
 * Client island for explore.
 *
 * Search, tabs and tag chips write to the URL; the Server Component re-renders
 * with the matching data. State that used to be duplicated here (the query, the
 * tag, the active tab) now has exactly one home: the address bar.
 */
export default function ExploreView({
  ...
  const updateUrlParams = (newQuery: string, newTag: string, newTab: TabType) => {
    ...
    // Inside a transition, so the pending server render can show a busy state
